...
protocol ICarModel {
    ...
    func getCar(for brandIndex: Int, and bodyIndex: Int) -> Car?
}
...
extension CarModel: ICarModel {
    ...
    func getCar(for brandIndex: Int, and bodyIndex: Int) -> Car? {
        let brand = self.getBrands()[brandIndex]
        let body = self.getBodys()[bodyIndex]
        
        return self.cars.first { $0.brand == brand && $0.body == body }
    }
