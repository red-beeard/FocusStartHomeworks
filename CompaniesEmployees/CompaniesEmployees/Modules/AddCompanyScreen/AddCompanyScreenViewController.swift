...
protocol IAddCompanyScreenViewController: UIViewController {
...
final class AddCompanyScreenViewController: UIViewController {
    
    private let presenter: IAddCompanyScreenPresenter
    private let addCompanyView: IAddCompanyScreenView
    ...
    init(presenter: IAddCompanyScreenPresenter) {
        self.presenter = presenter
        self.addCompanyView = AddCompanyScreenView()
...
extension AddCompanyScreenViewController: IAddCompanyScreenViewController {
