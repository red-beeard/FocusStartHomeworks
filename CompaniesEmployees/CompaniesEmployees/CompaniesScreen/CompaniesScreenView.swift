...
protocol ICompaniesScreenView: UIView {
    func getTableView() -> UITableView
}

final class CompaniesScreenView: UIView {
...
extension CompaniesScreenView: ICompaniesScreenView {
